Q_learning_Setting_3 <- function(gamma_start, save = F){
  ...
  if(save == T){
    dir.create("/data/cheungyb/home/e1404425/SharedQ/Simulation_random_walk/Setting3/calibration", showWarnings = FALSE, recursive = TRUE)
    saveRDS(data_original, "/data/cheungyb/home/e1404425/SharedQ/Simulation_random_walk/Setting3/calibration/data_original.rds")
  }
  ## Q3
...
library(Matrix)
library(caret)
source("/data/cheungyb/home/e1404425/SharedQ/Simulation_random_walk/Setting3/Q_datagenerating.R")
source("/data/cheungyb/home/e1404425/SharedQ/Simulation_random_walk/Setting3/Q_learning.R")
source("/data/cheungyb/home/e1404425/SharedQ/Simulation_random_walk/Setting3/Q_SQlearning.R")
source("/data/cheungyb/home/e1404425/SharedQ/Simulation_random_walk/Setting3/Q_SharedQ.R")
source("/data/cheungyb/home/e1404425/SharedQ/Simulation_random_walk/Setting3/Q_L2SQ.R")
Simu_III <- function(n, theta_true, nfolds = 5, metric = "MSE"){
  
  ## Results 1
  data_simu <- Generate_data(n)
  dir.create("/data/cheungyb/home/e1404425/SharedQ/Simulation_random_walk/Setting3/test_results", showWarnings = FALSE, recursive = TRUE)
  saveRDS(data_simu, "/data/cheungyb/home/e1404425/SharedQ/Simulation_random_walk/Setting3/test_results/temp.rds")
  print("results_1")
  ...
  lambda_final <- lambdas[which.min(cv_scores)]
  results_2 <- SQlearning(data_simu, warmstart = warmstart, lambda = lambda_final, D)
  results_2$theta
  ...
  lambda_final <- lambdas[which.min(cv_scores)]
  results_4 <- SQlearning_L2(data_simu, warmstart = warmstart, lambda = lambda_final, D=D, gamma = 0)
  results_4$theta
