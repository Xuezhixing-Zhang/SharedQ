...
## Load results
## ------------------------------------------------------------
source("/data/cheungyb/home/e1404425/SharedQ/Simulation_random_walk/Setting3/Q_functions.R")
pars <- readRDS("/data/cheungyb/home/e1404425/SharedQ/Simulation_random_walk/Setting3/calibration/alternative_pars.rds")
gamma_true <- pars$all_gamma[,which.min(pars$values)]
theta_true <- pars$all_theta[,which.min(pars$values)]
theta_true
results <- readRDS("/data/cheungyb/home/e1404425/SharedQ/Simulation_random_walk/Setting3/simulation_results/results_300.rds")
