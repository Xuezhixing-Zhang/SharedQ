Generate_data <- function(n){
  data_path <- "/data/cheungyb/home/e1404425/SharedQ/Simulation_random_walk/Setting2/calibration/data_original.rds"
  if (!file.exists(data_path)) {
    stop("Missing Monte Carlo population dataset: ", data_path,
         ". Run nloptr_Setting2.R or Q_learning_Setting_2(..., save = TRUE) first.")
  }
