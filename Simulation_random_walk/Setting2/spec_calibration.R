...
source(file.path(dirname(setting2_dir), "calibration_runner_utils.R"))
...
selected_specs <- select_calibration_specs(
  setting2_parameter_specs,
  default_spec = "separated_moderate"
)
output_dir <- calibration_output_dir(setting2_calibration_dir)
...
spec_results <- do.call(run_setting2_parameter_specs, c(
