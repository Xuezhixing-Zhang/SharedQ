...
- Current status: Current `calibration_balanced_small.rds` predates the rounded seed-63 target revision and must be replaced by a passing gate candidate before new production simulations are accepted.
