...
source(file.path(setting1_dir, "Q_SQlearning.R"))
source(file.path(setting1_dir, "Q_SharedQ.R"))
source(file.path(setting1_dir, "Q_L2SQ.R"))
source(file.path(setting1_dir, "Q_datagenerating.R"))
...
Simu_I <- function(
  ...
  data_simu <- prepare_setting1_data(data_simu)
