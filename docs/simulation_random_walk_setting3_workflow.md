...
- `Setting III.md` suggests trying multiple `sigma` values. That specification still needs a full multi-spec calibration wrapper analogous to Setting I/II if those scenarios are required for production.
