...
- Read `docs/simulation_random_walk_setting1_workflow.md`, `docs/simulation_random_walk_setting1_setting_i_design.md`, `docs/simulation_random_walk_setting1_shared_parameter_specifications.md`, and `docs/simulation_random_walk_setting1_handoff.md`.
...
- Added classification folders and `docs/simulation_random_walk_setting1_file_manifest.md`.
