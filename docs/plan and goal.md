...
- [ ] RW-CAL 2: Run bounded constrained calibration smoke checks for Setting I, Setting II, Setting III, and Supplementary Setting III No Shared.
- [ ] RW-CAL 3: Run production constrained calibration for all default and sensitivity specs; regenerate candidate calibration reports.
- [ ] RW-CAL 4: Review candidate coefficient and implied-difference errors; revise targets or constraints if any candidate group fails tolerance.
